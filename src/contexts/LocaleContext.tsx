...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "home.prompt.placeholder": "Additional details (e.g., 'wearing a blue suit', 'smiling')...",
    ...
    "profile.delete.message": "Are you sure you want to delete all images in this generation? This action cannot be undone.",
    ...
    "manage.cancel.message": "Your subscription will automatically renew. You can cancel anytime, and you'll continue to have access until the end of your billing period.",
    ...
    "lp.hero.subtitle": "Transform your selfies into professional-quality photos for LinkedIn, Social Media, and Dating apps. No photographer needed.",
  ...
  ja: {
    ...
    "pricing.subtitle": "プランを選択するか、クレジットを追加購入してください。",
    ...
    "home.prompt.placeholder": "追加の詳細 (例: '青いスーツを着ている', '笑っている')...",
    ...
    "profile.delete.message": "この生成のすべての画像を削除してもよろしいですか？この操作は取り消せません。",
    ...
    "manage.cancel.message": "サブスクリプションは自動更新されます。いつでもキャンセルでき、請求期間の終了までアクセス権は維持されます。",
    ...
    "lp.hero.subtitle": "自撮り写真を、LinkedIn、SNS、マッチングアプリ用のプロ品質の写真に変身させましょう。カメラマンは不要です。",
    "lp.cta.start": "無料で始める",
    ...
    "lp.features.standout.desc": "LinkedInやInstagramなどで存在感を高めましょう。",
    "lp.signin": "ログイン",
    "options.size": "画像サイズ",
